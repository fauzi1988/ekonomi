                ...
                <form method="POST" action="">
                  @csrf
                    ...
                    <div class="form-outline mb-4 col-6">
                       ...
                       <input type="text" name="judul" id="judul" class="form-control @error('judul') is-invalid @enderror" required autofocus value="{{ old('judul', $pengumuman->judul) }}" />
                       @error('judul')
                    ...
                    <div class="form-outline mb-4 col-6">
                     ...
                     <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" required value="{{ old('slug', $pengumuman->slug) }}"/>
                     @error('slug')
                        <div class="invalid-feedback">
                           {{ $message }}
                        </div>
                    ...
                    <div class="form-outline mb-4 col-6">
                        ...
                        <input type="text" name="penulis" id="penulis" value="{{ old('penulis', $pengumuman->penulis) }}" class="form-control @error('penulis') is-invalid @enderror" required/>
                        @error('penulis')
                        <div class="invalid-feedback">
                           {{ $message }}
                        </div>
