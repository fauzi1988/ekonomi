...
<html lang="en">
   <head>
      ...
      <!-- site icon -->
      <link rel="icon" href="{{ asset('back/pluto/images/Logo_IAIN.png') }}" type="image/png" />
      <!-- bootstrap css -->
   ...
   <body class="dashboard dashboard_1">
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="index.html"><img class="img-responsive" src="{{ asset('back/pluto/images/logo/logo1.png') }}" alt="#" /></a>
                        </div>
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="{{ asset('back/pluto/images/layout_img/user_img.jpg') }}" alt="#" /><span class="name_user">#</span></a>
      ...
      <!-- select country -->
      <script src="{{ asset('back/pluto/js/bootstrap-select.j') }}s"></script>
      <!-- owl carousel -->
      <script src="{{ asset('back/pluto/js/owl.carousel.js') }}"></script> 
      <!-- chart js -->
      <script src="{{ asset('back/pluto//Chart.min.js') }}"></script>
